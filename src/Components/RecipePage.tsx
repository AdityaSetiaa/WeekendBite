...
function RecipePage() {
  ...
  return (
   <div className="m-4 flex flex-wrap min-w-[40] max-w-250 justify-center  items-center ">
      <div className=" w-auto h-auto flex flex-col bg-gray-50 p-7 shadow-2xl rounded-3xl">
